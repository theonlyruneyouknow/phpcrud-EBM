...
$stmt = $pdo->prepare('SELECT * FROM possible_alums_with_comps where alum_id like :current_page');
	...
	<div class="pagination">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?=$contact['name']?></td>
                <td><a href="read_alumni_comp.php?page=<?=$contact['rm2_id']?>"><?=$contact['rm2_id']?></a>
